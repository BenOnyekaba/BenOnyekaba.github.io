...
function resizeAbout() {
    if ($("body").hasClass("home") && 0 == window.orientation) $(".image-content .content .visible > div:first-child").css({
        height: amplada + "px"
...
function nextProject(e, t, a, i) {
    ...
    n.find(".animate").removeClass("visible"), s.find(".container-1").css({
        ...
        s.css({
            "z-index": ""
        }), s.removeClass("active"), n.addClass("active"), $(".modules .active .content > div").addClass("visible"), $(".modules .active").find(".animate").addClass("visible"), $("body").hasClass("home") && $(".modules .active").find(".anim").addClass("startAnimation")
    }, .95 * e + t)
}
...
function gotoProject(e) {
    e = e, activeProject = $(".modules .active").index() + 1, console.log(e + " - " + activeProject), e != activeProject && (e > activeProject ? isMobile.tablet ? nextProject(temps1, temps2, 40, e) : nextProject(temps1, temps2, 0, e) : isMobile.tablet ? prevProject(temps1, temps2, 40, e) : prevProject(temps1, temps2, 0, e))
}
...
if ($(window).width() < 768) {
    ...
    $(window).resize(function() {
        resizeBackgroundHome(), resizeWorks(), resizeAbout()
    }), $(window).on("load", function() {
        $(".modules .module .content > div").addClass("visible"), resizeWorks(), resizeAbout(), resizeBackgroundHome(), window.addEventListener("orientationchange", function() {
            resizeWorks(), resizeAbout()
        }, !1), $(".header .custom > a").click(function(e) {
    ...
    $(window).resize(function() {
        ...
        resizeBackgroundHome(), isMobile.tablet ? $(".overlay").on("click touchstart", function() {}) : $(".overlay").click(function() {
            ...
            "backface-visibility": "hidden",
            "-webkit-transform": "translate3d(0px, -" + .1 * alcada + "px, 0px)",
            "-moz-transform": "translate3d(0px, -" + .1 * alcada + "px, 0px)",
            "-ms-transform": "translate3d(0px, -" + .1 * alcada + "px, 0px)",
            transform: "translate3d(0px, -" + .1 * alcada + "px, 0px)"
    ...
    }), $("body").hasClass("home") && $(window).scroll(function() {
        scrollbar.show()
    })
}